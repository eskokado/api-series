...
namespace Api.Application.Test.Movie.WhenToRequestFindCompleteByGenreName
{
    public class ReturnFind
    {
        ...
        public async Task It_is_possible_Find()
        {
            ...
            serviceMock.Setup(m => m.FindCompleteByGenreName("a")).ReturnsAsync(
            ...
            var result = await _controller.FindCompleteByGenreName("a");
